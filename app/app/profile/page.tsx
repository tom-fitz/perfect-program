  ...
  return (
    <div className="max-w-4xl mx-auto p-8">
      ...
      <div className="bg-white rounded-2xl shadow-sm border border-gray-200 overflow-hidden">
        {/* Profile Header */}
        <div className="relative h-32 bg-gradient-to-r from-ebony to-gray-800">
        ...
        <div className="pt-16 px-8 pb-8">
          <div className="flex justify-between items-start mb-6">
            ...
            >
              <button 
                type="submit"
                className="inline-flex items-center px-4 py-2 rounded-lg bg-red-50 text-red-700 hover:bg-red-100 transition-colors"
              >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            {/* Recent Activity */}
            <div className="md:col-span-2 p-6 rounded-xl bg-gray-50">
